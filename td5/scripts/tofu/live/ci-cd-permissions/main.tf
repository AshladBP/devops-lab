...
source = "github.com/AshladBP/devops-lab.git//td5/scripts/tofu/modules/github-aws-oidc"

provider_url = "https://token.actions.githubusercontent.com"
}

module "iam_roles" {
    source = "github.com/AshladBP/devops-lab.git//td5/scripts/tofu/modules/gh-actions-iam-roles"
